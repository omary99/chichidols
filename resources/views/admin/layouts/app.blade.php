...
<div class="wrapper" id="app">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="media">
                <img src="https://adminlte.iodist/themes/v3//img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
                <div class="media-body">
                <h3 class="dropdown-item-title">
                    Chichidolls
                <span class="float-right text-sm text-danger"><i class="fas fa-star"></i></span>
                </h3>
                <p class="text-sm">Your Beauty is our responsibility...</p>
                ...
                <p class="text-sm">Get dolled up, be fashionable!</p>
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 Hours Ago</p>
                </div>
                </div>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <span class="brand-text font-weight-light">Chichidolls Designer</span>
        </a>
        ...
        <div class="info">
        <a href="#" class="d-block">Chichidolls</a>
        </div>
        </div>
